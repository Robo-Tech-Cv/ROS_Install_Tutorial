...
PACKAGEDIR=/opt/ros/melodic/share/uuv_teleop

mkdir -p $PACKAGEDIR/scripts

cat > $PACKAGEDIR/scripts/vehicle_keyboard_teleop.py << EndOfMessage
#!/usr/bin/env python
...
chmod +x $PACKAGEDIR/scripts/vehicle_keyboard_teleop.py
